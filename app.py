...
from env.score_utils import MAX_SAFE_SCORE, SCORE_EPSILON
...
def get_metadata():
    return {
        ...
        "tasks": list_tasks(),
        "reward_range": [SCORE_EPSILON, MAX_SAFE_SCORE],
        "endpoints": {
            "reset": "/reset",
            "step": "/step",
            "state": "/state",
...
def get_schema():
    return {
        ...
        "reward": {
            "type": "object",
            "properties": {
                "score": {"type": "number", "exclusiveMinimum": 0.0, "exclusiveMaximum": 1.0},
